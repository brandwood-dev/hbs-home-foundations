...
const config = getCatalogPage("voilages-unis");
const title = "Voilages unis | HBS HOME";
const description =
  "Voilages unis blancs, ivoire et grège, transparents ou tamisants. Livraison partout en Tunisie.";

export const Route = createFileRoute("/voilages/unis")({
  ...
  component: CatalogVoilagesUnisPage,
});

function CatalogVoilagesUnisPage() {
