...
const config = getCatalogPage("mobilier-chaises");
const title = "Chaises de salle à manger | HBS HOME";
const description =
  "Chaises en bois massif, assise cannée ou paillée, à associer à nos galettes de chaise. Livraison en Tunisie.";

export const Route = createFileRoute("/mobilier/chaises")({
  ...
  component: CatalogMobilierChaisesPage,
});

function CatalogMobilierChaisesPage() {
