...
const config = getCatalogPage("plantes-artificielles");
const title = "Plantes artificielles réalistes | HBS HOME";
const description =
  "Oliviers, monsteras et feuillages artificiels réalistes, sans arrosage ni lumière. Livraison partout en Tunisie.";

export const Route = createFileRoute("/plantes/artificielles")({
  ...
  component: CatalogPlantesArtificiellesPage,
});

function CatalogPlantesArtificiellesPage() {
