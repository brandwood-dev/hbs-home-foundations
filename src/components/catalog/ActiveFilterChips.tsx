...
const GROUPS: { key: keyof CatalogSearch; facet: keyof CatalogFacets; numeric?: boolean }[] = [
  ...
  { key: "patterns", facet: "patterns" },
  { key: "blindTypes", facet: "blindTypes" },
  { key: "mountings", facet: "mountings" },
  { key: "furnitureTypes", facet: "furnitureTypes" },
  { key: "furnitureRooms", facet: "furnitureRooms" },
  { key: "furnitureStyles", facet: "furnitureStyles" },
  { key: "plantTypes", facet: "plantTypes" },
  { key: "plantNatures", facet: "plantNatures" },
  { key: "plantSizes", facet: "plantSizes" },
  { key: "plantCareLevels", facet: "plantCareLevels" },
  { key: "plantLightNeeds", facet: "plantLightNeeds" },
  { key: "controlSides", facet: "controlSides" },
