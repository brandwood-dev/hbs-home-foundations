...
const config = getCatalogPage("plantes-suspendues");
const title = "Plantes suspendues et macramé | HBS HOME";
const description =
  "Plantes retombantes en suspension macramé pour fenêtres, étagères et coins de salon. Livraison en Tunisie.";

export const Route = createFileRoute("/plantes/suspendues")({
  ...
  component: CatalogPlantesSuspenduesPage,
});

function CatalogPlantesSuspenduesPage() {
