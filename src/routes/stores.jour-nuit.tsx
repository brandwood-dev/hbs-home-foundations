...
const config = getCatalogPage("stores-jour-nuit");
const title = "Stores jour/nuit zébrés | HBS HOME";
const description =
  "Stores jour/nuit à bandes alternées : de la pleine lumière à l'intimité totale en un geste. Livraison en Tunisie.";

export const Route = createFileRoute("/stores/jour-nuit")({
  ...
  component: CatalogStoresJourNuitPage,
});

function CatalogStoresJourNuitPage() {
