...
const config = getCatalogPage("mobilier-tables");
const title = "Tables basses, tables d'appoint et consoles | HBS HOME";
const description =
  "Tables basses rondes, tables d'appoint et consoles d'entrée en bois massif, verre ou marbre. Livraison en Tunisie.";

export const Route = createFileRoute("/mobilier/tables")({
  ...
  component: CatalogMobilierTablesPage,
});

function CatalogMobilierTablesPage() {
