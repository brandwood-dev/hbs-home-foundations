...
export const Route = createFileRoute("/cookies")({
  loader: async ({ context }) => {
    const page = await context.queryClient.ensureQueryData(editorialPageQuery("cookies"));
  ...
  head: ({ loaderData }) => ({
    ...
    links: [{ rel: "canonical", href: "https://hbs-home.com/cookies" }],
  }),
...
function CookiesPage() {
  const { data: page } = useSuspenseQuery(editorialPageQuery("cookies"));
