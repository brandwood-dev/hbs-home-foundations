...
const config = getCatalogPage("plantes-cache-pots");
const title = "Pots et cache-pots décoratifs | HBS HOME";
const description =
  "Cache-pots en terre cuite, céramique émaillée et fibres tressées, plusieurs diamètres. Livraison en Tunisie.";

export const Route = createFileRoute("/plantes/cache-pots")({
  ...
  component: CatalogPlantesCachePotsPage,
});

function CatalogPlantesCachePotsPage() {
