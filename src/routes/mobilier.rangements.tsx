...
const config = getCatalogPage("mobilier-rangements");
const title = "Meubles TV, buffets et étagères | HBS HOME";
const description =
  "Meubles TV bas, buffets et étagères en bois massif et cannage. Livraison sur rendez-vous en Tunisie.";

export const Route = createFileRoute("/mobilier/rangements")({
  ...
  component: CatalogMobilierRangementsPage,
});

function CatalogMobilierRangementsPage() {
