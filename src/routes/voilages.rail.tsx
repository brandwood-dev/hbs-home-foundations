...
const config = getCatalogPage("voilages-rail");
const title = "Voilages pour rail plafond | HBS HOME";
const description =
  "Voilages compatibles rails plafond et muraux, avec un tombé net sur toute la hauteur. Livraison en Tunisie.";

export const Route = createFileRoute("/voilages/rail")({
  ...
  component: CatalogVoilagesRailPage,
});

function CatalogVoilagesRailPage() {
