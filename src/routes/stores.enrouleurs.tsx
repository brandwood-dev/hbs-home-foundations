...
const config = getCatalogPage("stores-enrouleurs");
const title = "Stores enrouleurs | HBS HOME";
const description =
  "Stores enrouleurs tamisants et occultants, en pose murale, plafond ou sans perçage. Livraison en Tunisie.";

export const Route = createFileRoute("/stores/enrouleurs")({
  ...
  component: CatalogStoresEnrouleursPage,
});

function CatalogStoresEnrouleursPage() {
