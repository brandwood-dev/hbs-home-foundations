...
const config = getCatalogPage("plantes-compositions");
const title = "Fleurs séchées et compositions | HBS HOME";
const description =
  "Bouquets de pampa, eucalyptus stabilisé et compositions séchées pour console et table. Livraison en Tunisie.";

export const Route = createFileRoute("/plantes/compositions")({
  ...
  component: CatalogPlantesCompositionsPage,
});

function CatalogPlantesCompositionsPage() {
