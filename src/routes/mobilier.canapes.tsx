...
const config = getCatalogPage("mobilier-canapes");
const title = "Canapés en tissu et velours | HBS HOME";
const description =
  "Canapés 2 et 3 places en lin, velours et bouclette. Livraison sur rendez-vous partout en Tunisie.";

export const Route = createFileRoute("/mobilier/canapes")({
  ...
  component: CatalogMobilierCanapesPage,
});

function CatalogMobilierCanapesPage() {
