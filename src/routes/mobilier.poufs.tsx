...
const config = getCatalogPage("mobilier-poufs");
const title = "Poufs et assises d'appoint | HBS HOME";
const description =
  "Poufs ronds en velours, cuir synthétique et fibres naturelles, à poser au salon ou en bout de lit.";

export const Route = createFileRoute("/mobilier/poufs")({
  ...
  component: CatalogMobilierPoufsPage,
});

function CatalogMobilierPoufsPage() {
