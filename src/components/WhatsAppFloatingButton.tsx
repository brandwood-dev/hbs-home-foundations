...
export function WhatsAppFloatingButton() {
  ...
  return (
    <a
      ...
      className="fixed z-40 flex h-14 w-14 min-h-14 min-w-14 items-center justify-center rounded-full bg-whatsapp text-whatsapp-foreground shadow-soft ring-offset-2 transition-all hover:shadow-lg focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring motion-safe:animate-whatsapp-pulse"
      style={{
