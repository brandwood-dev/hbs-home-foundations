  ...
  return (
    <div
      className={cn(
        ...
        value.preset === "custom"
          ? "flex-col gap-2 p-2 lg:h-8 lg:flex-row lg:flex-nowrap lg:gap-0 lg:p-0"
    ...
    >
      <div
        className={cn(
          ...
          value.preset === "custom"
            ? "px-2.5 lg:border-r lg:border-border lg:px-3 lg:pr-3"
            : "px-2",
        )}
      >
        ...
        >
          <SelectTrigger
            ...
            className={cn(
              ...
              value.preset === "custom" ? "h-8 min-w-[188px] px-2" : "h-8 min-w-40 px-1.5",
            )}
          >
            <SelectValue />
          </SelectTrigger>
      ...
      {value.preset === "custom" ? (
        <div className="grid min-w-0 flex-1 grid-cols-1 gap-2 px-1 lg:flex lg:flex-none lg:items-center lg:gap-2 lg:pl-2 lg:pr-2">
          <label className="flex min-w-0 items-center gap-2 text-xs text-muted-foreground lg:flex-none lg:whitespace-nowrap">
            ...
            <Input
              ...
              className="h-9 min-w-0 flex-1 px-2.5 pr-8 text-sm sm:min-w-[148px] sm:flex-none sm:w-[148px] lg:h-8 lg:w-[152px]"
          ...
          <Button
            ...
            className="h-9 w-full px-3 sm:col-span-2 lg:h-8 lg:w-auto"
          >
