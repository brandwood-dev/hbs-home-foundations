...
const config = getCatalogPage("voilages-motifs");
const title = "Voilages brodés et à motifs | HBS HOME";
const description =
  "Voilages brodés, rayés, imprimés et jacquard. Des motifs délicats qui habillent la fenêtre sans l'alourdir.";

export const Route = createFileRoute("/voilages/motifs")({
  ...
  component: CatalogVoilagesMotifsPage,
});

function CatalogVoilagesMotifsPage() {
